  ...
  public static void main(String[] arguments) {
    ...
    try {
      ...
      try {
        ...
        l_registry = LocateRegistry.createRegistry(1106);
      } catch (Exception e) {
        // Registry already exists on the port 1106
        l_registry = LocateRegistry.getRegistry(1106);
      }
      final Registry registry = l_registry;
      // serverName = Middlware
    ...
    try {
      middleware.carRMI.addCars(0, "zhengzhou", 10, 50);
      middleware.flightRMI.addFlight(1, 747, 4, 100);
      middleware.roomRMI.addRooms(1, "henan", 4, 100);
    } catch (RemoteException e) {
