...
public enum Command {
	...
	CustomerDetails("Provide detailed summary of  Customer ", "<xid>"),
	ResourceManagerDetails("Provide Detail summary of all reservable items in Remote Resource Managers Server ",
			"<xid>"),

	// Start("Start Transaction", ""),
	Commit("Commit Transaction", "<xid>"), Abort("Abort a Transaction ", "<xid>"), Start("Start Transaction", ""),
