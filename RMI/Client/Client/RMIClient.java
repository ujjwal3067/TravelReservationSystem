...
public class RMIClient extends Client {
  ...
  private static int s_serverPort = 2106;
  ...
  // For testing.
  public RMIClient(String hostName, String middleware) {
    super();
    s_serverHost = hostName;
    s_serverName = middleware;
    // if (System.getSecurityManager() == null) {
    // System.setSecurityManager(new SecurityManager());
    // }
    ...
    try {
      ...
      while (true) {
        try {
          ...
          System.out.println("looking for " + s_rmiPrefix + name);
